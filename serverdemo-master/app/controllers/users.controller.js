...
router.post('/ticketinfoUser',ticketinfoUser);
...
function ticketinfoUser(req, res) {
    
    userService.getTicketInfoUser(req.body.ownername)
        .then(function (ticket) {
            res.send(ticket);
        })
        .catch(function (err) {
...
function statusChange(req, res) {
    ...
    userService.statusUpdate(req.body.ownername)
        .then(function () {
            res.json('success');
        })
        .catch(function (err) {
