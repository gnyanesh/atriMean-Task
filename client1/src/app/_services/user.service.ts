...
export class UserService {
    ...
    gettic(){
        return this.http.get<Book[]>(appConfig.apiUrl + '/users/tic');
               }
    ...
    statusUpdate(ownername:string){
    console.log(ownername);
    return this.http.post(appConfig.apiUrl + '/users/statusChange', { ownername: ownername })
        .map(status => {
     ...
     hardwarestatusUpdate(ownername:string){
    console.log(ownername);
    return this.http.post(appConfig.apiUrl + '/users/hardwarestatusChange', { ownername: ownername })
        .map(status => {
    ...
    statusName(ownername:string){
    console.log(ownername);
    return this.http.post(appConfig.apiUrl + '/users/nameChange', { ownername: ownername })
        .map(status => {
    ...
    ticinfoUser(ownername: string){
        console.log(ownername);
        return this.http.post<any>(appConfig.apiUrl + '/users/ticketinfoUser', { ownername: ownername })
        .map(ticket => {
